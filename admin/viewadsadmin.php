...
<body>
  ...
  $select="SELECT new_ad.email,new_ad.target_url,new_ad.adname,new_ad.amount,new_ad.imagepath,new_ad.ad_height,new_ad.ad_width,new_ad.startdate,new_ad.enddate,advertiser_register.advertiser_name,advertiser_register.contact FROM new_ad INNER JOIN advertiser_register ON new_ad.email=advertiser_register.email WHERE new_ad.email=advertiser_register.email";
